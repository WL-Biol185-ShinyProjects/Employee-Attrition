                           ...
                           dashboardBody(
                             fluidRow(
                               box(
                                 ...
                                 p("Healthcare burnout was a crisis long before the coronavirus pandemic hit.
                                 ...
                                 br(), 
                                 p("Burnout symptoms include “insomnia, depression, anxiety, post-traumatic stress disorder, and other mental health challenges (Murthy, 2022, N Engl J Med).” 
                                 ...
                                 br(),
                                 p("The coronavirus pandemic escalated burnout symptoms in health care workers and left many of them on the brink of quitting. 
                                 ...
                                 br(),
                                 p("The Delta and Omicron surges sent many unvaccinated patients into hospitals where health care employees were already emotionally and physically exhausted from the last 18 months of the pandemic. 
                               ...
                               box(
                                 ...
                                 tags$ol(
                                   tags$li(p("This data set shows the critical need for changes to the healthcare system.")),
                                   tags$li(p("Health care workers need to be protected and valued. 
                                   ...
                                   tags$li(p("We need to help reduce the administrative burdens. 
                                   ...
                                   tags$li(p("We need to increase access to mental healthcare. 
                                   ...
                                   tags$li(p("We also need public investments in health infrastructure that focus on addressing the social determinants of health which would reduce the demands on the healthcare system. ")),
                                   tags$li(p("We need to change the narrative that suffering is just an essential component of health professions. 
